...
you need to remove  python bytecode generated by running the following command:
...
container id for the maching labeled as ``test_python`` by running the following
command:
