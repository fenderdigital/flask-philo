...
Flaskutils uses SQLAlchemy as an ORM. In order to create simple models all you have to do is
create classes that inherit from Flask-Philo ``BaseModel``.
...
The following are examples about how to use 
